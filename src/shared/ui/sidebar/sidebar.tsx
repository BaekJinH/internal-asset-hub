...
const SIDEBAR_STORAGE_KEY = 'asset-hub-sidebar-collapsed'
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[var(--sidebar-width)] border-sidebar-border bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
          ...
          >
            <SheetHeader className="sr-only">
              ...
              <SheetDescription>모바일 내비게이션 메뉴입니다.</SheetDescription>
            </SheetHeader>
